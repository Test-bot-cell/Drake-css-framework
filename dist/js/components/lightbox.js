...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('drakelightbox', ['drake-util'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.DrakeLightbox = factory(global.Drake.util));
    ...
    var Component = defineComponent()({
      ...
      events: {
        ...
        handler(e) {
          if (!e.defaultPrevented) {
            e.preventDefault();
            if (e.current instanceof HTMLElement && !util.matches(e.current, selDisabled)) {
              this.show(e.current);
            }
          }
        }
    ...
    function install(Drake, Lightbox) {
      ...
      if (panelProps && !Array.isArray(panelProps)) {
        util.assign(Lightbox.props, panelProps);
      }
    }
