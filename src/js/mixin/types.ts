...
export interface SliderInstance extends ComponentInternalInstance {
    ...
    $props: ComponentValueMap & { index: SliderIndex };
    easing: string;
    finite: boolean;
    velocity: number;
    index: number;
    ...
    _show(
        previous: HTMLElement | false | undefined,
...
export type ToggleAnimationHandler = (
    element: HTMLElement,
    show: boolean,
    component: TogglableInstance,
...
export interface TogglableInstance extends ComponentInternalInstance {
    ...
    toggleElement(
        targets: Node | ArrayLike<Node> | Iterable<Node> | null | undefined,
        toggle?: boolean,
